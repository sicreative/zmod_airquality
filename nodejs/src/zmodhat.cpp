...
int8_t zmodhat_read_meassurement(){
   ...
   //     float rmox[13] = {0.0};
   //     zmod4xxx_calc_rmox(&zmodhat_dev,zmodhat_sensor_result,rmox);
    
   //  for(int i=0;i<13;i++)
   //     printf("[%6.3f]",rmox[i] / 1e3 );
        
   // printf("\n");
    
    //for(int i=0;i<32;i++)
    //    printf("%02xd",zmodhat_sensor_result[i]);
    ...
    //  for(int i=0;i<13;i++)
    //    printf("%.3f=",zmodhat_results.rmox[i]);

   // printf("\n");

  //printf("%d  ",zmodhat_iaq_handle.sample_number);
